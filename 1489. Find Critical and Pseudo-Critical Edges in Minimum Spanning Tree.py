...
# Will get back to it once I achieve an Expert level
...
class Solution:
    ...
    def findCriticalAndPseudoCriticalEdges(self, n, edges):
        ...
        # subset of Graph's edges - that connects all vertices without making cycles - with min possible total weight 
        # critical edge - deleting that edge will increase MST weight
        
        # Question states that --
        # n vertices of a undirected connected graph 0 - n-1
        # edges -> [a, b, weight]
